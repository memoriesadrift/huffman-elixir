defmodule Huffman.Reporting do
  ...
  @spec generate_report(String.t(), String.t(), String.t(), fun) :: <<_::64, _::_*8>>
  def generate_report(filepath, filename, filetype, filter_fn) do
  ...
  @spec generate_multifile_report([String.t()], String.t(), String.t(), fun) ::
          <<_::64, _::_*8>>
  def generate_multifile_report(
        filenames,
        filepath \\ "input",
        filetype \\ "txt",
        filter_fn \\ fn e -> e end
      ) do
    data =
      filenames
      ...
      |> Statistics.generate_multisample_statistical_data()
